...
- **No inline `<script>` in templates** — the Content-Security-Policy keeps `script-src 'self'`. Editor setup lives in `META-INF/resources/js/editor-init.js`.
