...
public class LoginE2ETest extends PlaywrightTestBase {
    ...
    @Test
    public void login_with_demo_credentials_shows_logout_link() {
        ...
        assertThat(page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Ausloggen")).isVisible(), is(true));
    }
    ...
    public void failed_login_shows_error_page() {
        ...
        assertThat(page.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Ausloggen")).isVisible(), is(false));
    }
}
