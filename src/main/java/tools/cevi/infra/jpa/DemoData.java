...
public class DemoData {
    ...
    void startup(@Observes StartupEvent event) {
        ...
        if (events.isEmpty()) {
            ...
            createVoluntaryService("Volunteers for Europe", "http://vfe.cvjm.de/", "Kolumbien, Palästina",  "Dauer 2 Wochen oder 3-6 Monate. Siehe <a href=\"https://horyzon.ch/de/spenden-und-unterstuetzen/einsaetze-weltweit/volontariat/\">Weitere Informationen</a>");
            ...
            Log.info("Database was empty, generated some demo data");
        }
    }
    ...
    private void createVoluntaryService(String organization, String organizationLink, String location, String description) {
        VoluntaryServiceEntity entity = new VoluntaryServiceEntity();
        entity.organization = organization;
        entity.organizationLink = organizationLink;
